    ...
    return (
      <div className=" pt-16 sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div >
            <span className="text-base font-bold tracking-wide text-gray-900"> Contact</span>
            <div className="flex">
            ...
            <div className="flex">
              ...
              <a
                href="mailto:info@equisports.mail"
                aria-label="Our email"
                title="Our email"
                className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800"
              >
                info@equipsports.mail
              </a>
            </div>
            <div className="flex">
          ...
          <div>
            ...
            <div className="flex items-center mt-1 space-x-3">
              <a
                  href="https://www.x.com/equisports"
                  target="_blank"
              ...
              <a
                href="https://www.instagram.com/equisports" target="_blank"
                className="text-gray-500 transition-colors duration-300 hover:text-deep-purple-accent-400"
              >
              ...
              <a
                href="https://www.facebook.com/equisports" target="_blank"
                className="text-gray-500 transition-colors duration-300 hover:text-deep-purple-accent-400"
              >
                <svg viewBox="0 0 24 24" fill="currentColor" className="h-5">
        ...
        <div className="border-t ">
          <p className="py-2 text-sm text-gray-600 text-center">
            © Copyright 2025 EquiSports. All rights reserved.
          </p>
